...
class DuplicateProcessor:
    ...
    def __init__(self, config_folder: str, output_folder: str, source_base: str, target_base: str):
        """
        ...
        beets_input_file = output_folder + "/beets-duplicates.json"
