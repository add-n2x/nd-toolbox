...
class DuplicateProcessor:
    ...
    def print_stats(self):
        ...
        PU.println()
        PU.print(" Duplicates:")
        PU.print(f"     Records: {self.stats.duplicate_records}")
        PU.print(f"     Files: {self.stats.duplicate_files}")
        PU.print(f"     Artists: {len(self.db.artists)}")
        PU.print(f"     Albums: {len(self.db.albums)}")
        PU.print("")
        PU.print(" Media files:")
        PU.print(f"     Found: {self.stats.media_files}")
        PU.print(f"     Annotations: {self.stats.file_annotations}")
        PU.print(f"     Deletables: {self.stats.media_files_deletable}")
        PU.print("")
        PU.green(f" Finished in {self._get_duration()} seconds")
